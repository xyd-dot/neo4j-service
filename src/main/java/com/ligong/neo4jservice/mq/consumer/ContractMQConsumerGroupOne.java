...
@Slf4j
@Component
public class ContractMQConsumerGroupOne implements MessageListenerConcurrently {
    ...
    public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> list, ConsumeConcurrentlyContext consumeConcurrentlyContext) {
        ...
        try {
            Neo4jDataSourceContextHolder.setDataSourceKey("ds1");
            ...
            log.error("neo4j 节点1 消费失败，cypher语句详情:{}",JSON.toJSONString(cyphers),e);
